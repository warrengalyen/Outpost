          ...
          <TabsContent value="for-buyers">
            ...
            >
              ...
              <div className="bg-blue-900 text-white w-full p-12 rounded-md mt-12 flex items-center flex-col gap-2 justify-center text-center">
                ...
                <p className="text-3xl font-bold">Toy Box</p>
                <p>
                  Top seller of the month! Toy Box has been selling toys for 10
                  years and is a top rated seller on the platform.
                </p>
                <Link
                  href={routes.products + "?seller=toy-box"}
                  className="mt-6"
                >
